...
HD_PWD='/media/bozhao/Storage/Study USN/VHDL/Oppgave/Oppgave intro2/Oppgave 2/Three_bit_subtractor/Three_bit_subtractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Three_bit_subtrator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Three_bit_subtrator.tcl
