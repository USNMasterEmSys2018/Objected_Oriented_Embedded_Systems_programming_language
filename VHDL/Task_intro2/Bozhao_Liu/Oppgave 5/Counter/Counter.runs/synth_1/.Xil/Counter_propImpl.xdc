set_property SRC_FILE_INFO {cfile:{/media/bozhao/Storage/Study USN/VHDL/Oppgave/Oppgave intro2/Oppgave 5/Counter/Counter.srcs/constrs_1/new/counter.xdc} rfile:../../../Counter.srcs/constrs_1/new/counter.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { count }]; #IO_L20N_T3_34 Sch=BTN0
set_property src_info {type:XDC file:1 line:21 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { store_status }]; #IO_L24N_T3_34 Sch=BTN1
set_property src_info {type:XDC file:1 line:22 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { read }]; #IO_L18P_T2_34 Sch=BTN2
set_property src_info {type:XDC file:1 line:23 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { UporDown }]; #IO_L7P_T1_34 Sch=BTN3
