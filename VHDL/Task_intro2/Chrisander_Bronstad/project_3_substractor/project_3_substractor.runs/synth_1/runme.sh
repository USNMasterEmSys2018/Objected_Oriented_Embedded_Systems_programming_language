...
HD_PWD='D:/Xilinx_Projects/project_3_substractor/project_3_substractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_sub.tcl
