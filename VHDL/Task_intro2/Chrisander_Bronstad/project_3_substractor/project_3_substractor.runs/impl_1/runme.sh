...
HD_PWD='D:/Xilinx_Projects/project_3_substractor/project_3_substractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sub.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_sub.tcl -notrace
