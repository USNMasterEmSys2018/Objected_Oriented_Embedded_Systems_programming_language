...
HD_PWD='D:/USN_Study/Objected_Oriented_Embedded_Systems_programming_language/VHDL/Task_intro3/Bozhao_Liu/Assignment/Oppgave 3/warning/warning.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log warning.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source warning.tcl
