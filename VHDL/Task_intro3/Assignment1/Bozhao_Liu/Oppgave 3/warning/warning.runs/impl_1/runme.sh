...
HD_PWD='D:/USN_Study/Objected_Oriented_Embedded_Systems_programming_language/VHDL/Task_intro3/Bozhao_Liu/Assignment/Oppgave 3/warning/warning.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log warning.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source warning.tcl -notrace
