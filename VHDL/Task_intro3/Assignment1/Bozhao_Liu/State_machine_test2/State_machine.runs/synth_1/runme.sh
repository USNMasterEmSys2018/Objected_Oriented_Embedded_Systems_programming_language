...
HD_PWD='D:/USN_Study/Objected_Oriented_Embedded_Systems_programming_language/VHDL/Task_intro3/Assignment1/Bozhao_Liu/State_machine_test2/State_machine.runs/synth_1'
cd "$HD_PWD"
