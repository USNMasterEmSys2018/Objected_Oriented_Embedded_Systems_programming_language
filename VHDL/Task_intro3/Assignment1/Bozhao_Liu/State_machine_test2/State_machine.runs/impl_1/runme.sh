...
HD_PWD='D:/USN_Study/Objected_Oriented_Embedded_Systems_programming_language/VHDL/Task_intro3/Assignment1/Bozhao_Liu/State_machine_test2/State_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log State_machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source State_machine.tcl -notrace
