...
HD_PWD='/media/bozhao/Storage/Study USN/VHDL/Oppgave/Oppgave intro2/Oppgave 2/Three_bit_subtractor/Three_bit_subtractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Three_bit_subtrator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Three_bit_subtrator.tcl -notrace
