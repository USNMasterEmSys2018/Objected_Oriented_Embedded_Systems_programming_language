set_property SRC_FILE_INFO {cfile:{/media/bozhao/Storage/Study USN/VHDL/Oppgave/Oppgave intro2/Oppgave 4/Comb_Sub_Adder/Comb_Sub_Adder.srcs/constrs_1/new/Comb_sub_Adder.xdc} rfile:../../../Comb_Sub_Adder.srcs/constrs_1/new/Comb_sub_Adder.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { switch }]; #IO_L9P_T1_DQS_34 Sch=SW3
...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { trigger }]; #IO_L7P_T1_34 Sch=BTN3
