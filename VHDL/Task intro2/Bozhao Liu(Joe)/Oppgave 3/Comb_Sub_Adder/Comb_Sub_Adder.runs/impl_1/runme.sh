...
HD_PWD='/media/bozhao/Storage/Study USN/VHDL/Oppgave/Oppgave intro2/Oppgave 3/Comb_Sub_Adder/Comb_Sub_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Comb_Sub_Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Comb_Sub_Adder.tcl -notrace
