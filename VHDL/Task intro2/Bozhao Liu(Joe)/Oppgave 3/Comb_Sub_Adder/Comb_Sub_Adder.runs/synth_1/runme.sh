...
HD_PWD='/media/bozhao/Storage/Study USN/VHDL/Oppgave/Oppgave intro2/Oppgave 3/Comb_Sub_Adder/Comb_Sub_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comb_Sub_Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comb_Sub_Adder.tcl
