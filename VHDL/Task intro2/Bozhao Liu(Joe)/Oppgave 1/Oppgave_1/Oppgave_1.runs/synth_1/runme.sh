...
HD_PWD='/media/bozhao/Storage/Study USN/VHDL/Oppgave/Oppgave intro2/Oppgave 1/Oppgave_1/Oppgave_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Three_bit_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Three_bit_adder.tcl
