...
HD_PWD='/media/bozhao/Storage/Study USN/VHDL/Oppgave/Oppgave intro2/Oppgave 1/Oppgave_1/Oppgave_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Three_bit_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Three_bit_adder.tcl -notrace
